...
function AddXpPro() {
    ...
    return <>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center gap-5 px-36 py-10'>
            ...
            <input className="w-96 h-10 px-2 rounded-xl bg-transparent border-2 border-zinc-300" value={selectedDomaine} type="text" name="" maxLength={50} id="" placeholder="Titre" onChange={(e) => { handleDomaine(e); }} required />
            ...
            <input className="w-96 h-10 px-2 rounded-xl bg-transparent border-2 border-zinc-300" value={selectedTitre} type="text" name="" maxLength={50} id="" placeholder="Annee" onChange={(e) => { handleTitre(e); }} required />
            <input className="w-96 h-10 px-2 rounded-xl bg-transparent border-2 border-zinc-300" value={selectedMission} type="text" name="" maxLength={50} id="" placeholder="Annee" onChange={(e) => { handleMission(e); }} required />
