...
function UnParcours() {
    ...
    return <>
        ...
        <BtnReturn />
        <form onSubmit={handleEditSubmit} className='flex flex-col justify-center items-center gap-5 px-36 py-10 w-1/2'>
            <div className='flex w-full items-center'>
                <label htmlFor="date" className='w-1/6'>Date : </label>
                <input className="w-5/6 h-10 px-2 rounded-xl bg-transparent border-2 border-zinc-300" value={selectedDate} type="text" name="" id="date" placeholder="Date" onChange={(e) => { handleDate(e); }} required />
            </div>
            <div className='flex w-full items-center'>
